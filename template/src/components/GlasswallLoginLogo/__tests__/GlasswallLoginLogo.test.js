...
import GlasswallLoginLogo from "../GlasswallLoginLogo";
...
test("GlasswallLoginLogo_Snapshot", () => {
    // Arrange
    const component = TestRenderer.create(<GlasswallLoginLogo />);
...
test("Renders_Logo_Div", () => {
    // Arrange
    const { getByTestId } = render(<GlasswallLoginLogo />);
